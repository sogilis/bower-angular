/*
 ...
 License: MIT
*/
(function(Y,O,r){'use strict';function s(b){return function(){var a=arguments[0],c,a="["+(b?b+":":"")+a+"] http://errors.angularjs.org/1.2.6.1/"+(b?b+"/":"")+a;for(c=1;c<arguments.length;c++)a=a+(1==c?"?":"&")+"p"+(c-1)+"="+encodeURIComponent("function"==typeof arguments[c]?arguments[c].toString().replace(/ \{[\s\S]*$/,""):"undefined"==typeof arguments[c]?"undefined":"string"!=typeof arguments[c]?JSON.stringify(arguments[c]):arguments[c]);return Error(a)}}function ob(b){if(null==b||ya(b))return!1;
var a=b.length;return 1===b.nodeType&&a?!0:E(b)||I(b)||0===a||"number"===typeof a&&0<a&&a-1 in b}function q(b,a,c){var d;if(b)if(K(b))for(d in b)"prototype"==d||("length"==d||"name"==d||b.hasOwnProperty&&!b.hasOwnProperty(d))||a.call(c,b[d],d);else if(b.forEach&&b.forEach!==q)b.forEach(a,c);else if(ob(b))for(d=0;d<b.length;d++)a.call(c,b[d],d);else for(d in b)b.hasOwnProperty(d)&&a.call(c,b[d],d);return b}function Nb(b){var a=[],c;for(c in b)b.hasOwnProperty(c)&&a.push(c);return a.sort()}function Nc(b,
...
10)}function Qb(b,a){return x(new (x(function(){},{prototype:b})),a)}function y(){}function za(b){return b}function $(b){return function(){return b}}function D(b){return"undefined"===typeof b}function w(b){return"undefined"!==typeof b}function V(b){return null!=b&&"object"===typeof b}function E(b){return"string"===typeof b}function pb(b){return"number"===typeof b}function Ja(b){return"[object Date]"===Ya.call(b)}function I(b){return"[object Array]"===Ya.call(b)}function K(b){return"function"===typeof b}
...
function Sb(){return O.securityPolicy&&O.securityPolicy.isActive||O.querySelector&&!(!O.querySelector("[ng-csp]")&&!O.querySelector("[data-ng-csp]"))}function qb(b,a){var c=2<arguments.length?ua.call(arguments,2):[];return!K(a)||a instanceof RegExp?a:c.length?function(){return arguments.length?a.apply(b,c.concat(ua.call(arguments,0))):a.apply(b,c)}:function(){return arguments.length?a.apply(b,arguments):a.call(b)}}function Qc(b,a){var c=a;"string"===typeof b&&"$"===b.charAt(0)?c=r:ya(a)?c="$WINDOW":
a&&O===a?c="$DOCUMENT":a&&(a.$evalAsync&&a.$watch)&&(c="$SCOPE");return c}function oa(b,a){return"undefined"===typeof b?r:JSON.stringify(b,Qc,a?"  ":null)}function Tb(b){return E(b)?JSON.parse(b):b}function Ma(b){b&&0!==b.length?(b=C(""+b),b=!("f"==b||"0"==b||"false"==b||"no"==b||"n"==b||"[]"==b)):b=!1;return b}function fa(b){b=v(b).clone();try{b.empty()}catch(a){}var c=v("<div>").append(b).html();try{return 3===b[0].nodeType?C(c):c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,function(a,b){return"<"+
C(b)})}catch(d){return C(c)}}function Ub(b){try{return decodeURIComponent(b)}catch(a){}}function Vb(b){var a={},c,d;q((b||"").split("&"),function(b){b&&(c=b.split("="),d=Ub(c[0]),w(d)&&(b=w(c[1])?Ub(c[1]):!0,a[d]?I(a[d])?a[d].push(b):a[d]=[a[d],b]:a[d]=b))});return a}function Wb(b){var a=[];q(b,function(b,d){I(b)?q(b,function(b){a.push(va(d,!0)+(!0===b?"":"="+va(b,!0)))}):a.push(va(d,!0)+(!0===b?"":"="+va(b,!0)))});return a.length?a.join("&"):""}function rb(b){return va(b,!0).replace(/%26/gi,"&").replace(/%3D/gi,
...
a){if("hasOwnProperty"===b)throw La("badname",a);}function tb(b,a,c){if(!a)return b;a=a.split(".");for(var d,e=b,g=a.length,f=0;f<g;f++)d=a[f],b&&(b=(e=b)[d]);return!c&&K(b)?qb(e,b):b}function ub(b){var a=b[0];b=b[b.length-1];if(a===b)return v(a);var c=[a];do{a=a.nextSibling;if(!a)break;c.push(a)}while(a!==b);return v(c)}function Tc(b){var a=s("$injector"),c=s("ng");b=b.angular||(b.angular={});b.$$minErr=b.$$minErr||s;return b.module||(b.module=function(){var b={};return function(e,g,f){if("hasOwnProperty"===
...
"register"),controller:b("$controllerProvider","register"),directive:b("$compileProvider","directive"),config:m,run:function(a){d.push(a);return this}};f&&m(f);return n}())}}())}function Pa(b){return b.replace(Uc,function(a,b,d,e){return e?d.toUpperCase():d}).replace(Vc,"Moz$1")}function vb(b,a,c,d){function e(b){var e=c&&b?[this.filter(b)]:[this],l=a,k,m,n,p,u,t;if(!d||null!=b)for(;e.length;)for(k=e.shift(),m=0,n=k.length;m<n;m++)for(p=v(k[m]),l?p.triggerHandler("$destroy"):l=!l,u=0,p=(t=p.children()).length;u<
p;u++)e.push(Aa(t[u]));return g.apply(this,arguments)}var g=Aa.fn[b],g=g.$original||g;e.$original=g;Aa.fn[b]=e}function N(b){if(b instanceof N)return b;if(!(this instanceof N)){if(E(b)&&"<"!=b.charAt(0))throw wb("nosel");return new N(b)}if(E(b)){var a=O.createElement("div");a.innerHTML="<div>&#160;</div>"+b;a.removeChild(a.firstChild);xb(this,a.childNodes);v(O.createDocumentFragment()).append(this)}else xb(this,b)}function yb(b){return b.cloneNode(!0)}function Ba(b){Zb(b);var a=0;for(b=b.childNodes||
[];a<b.length;a++)Ba(b[a])}function $b(b,a,c,d){if(w(d))throw wb("offargs");var e=ja(b,"events");ja(b,"handle")&&(D(a)?q(e,function(a,c){zb(b,c,a);delete e[c]}):q(a.split(" "),function(a){D(c)?(zb(b,a,e[a]),delete e[a]):Ka(e[a]||[],c)}))}function Zb(b,a){var c=b[bb],d=Qa[c];d&&(a?delete Qa[c].data[a]:(d.handle&&(d.events.$destroy&&d.handle({},"$destroy"),$b(b)),delete Qa[c],b[bb]=r))}function ja(b,a,c){var d=b[bb],d=Qa[d||-1];if(w(c))d||(b[bb]=d=++Wc,d=Qa[d]={}),d[a]=c;else return d&&d[a]}function ac(b,
a,c){var d=ja(b,"data"),e=w(c),g=!e&&w(a),f=g&&!V(a);d||f||ja(b,"data",d={});if(e)d[a]=c;else if(g){if(f)return d&&d[a];x(d,a)}else return d}function Ab(b,a){return b.getAttribute?-1<(" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").indexOf(" "+a+" "):!1}function Bb(b,a){a&&b.setAttribute&&q(a.split(" "),function(a){b.setAttribute("class",aa((" "+(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ").replace(" "+aa(a)+" "," ")))})}function Cb(b,a){if(a&&b.setAttribute){var c=(" "+
(b.getAttribute("class")||"")+" ").replace(/[\n\t]/g," ");q(a.split(" "),function(a){a=aa(a);-1===c.indexOf(" "+a+" ")&&(c+=a+" ")});b.setAttribute("class",aa(c))}}function xb(b,a){if(a){a=a.nodeName||!w(a.length)||ya(a)?[a]:a;for(var c=0;c<a.length;c++)b.push(a[c])}}function bc(b,a){return cb(b,"$"+(a||"ngController")+"Controller")}function cb(b,a,c){b=v(b);9==b[0].nodeType&&(b=b.find("html"));for(a=I(a)?a:[a];b.length;){for(var d=0,e=a.length;d<e;d++)if((c=b.data(a[d]))!==r)return c;b=b.parent()}}
...
b){return c(a,{$get:b})}function e(a){var b=[],c,d,h,g;q(a,function(a){if(!k.get(a)){k.put(a,!0);try{if(E(a))for(c=Ta(a),b=b.concat(e(c.requires)).concat(c._runBlocks),d=c._invokeQueue,h=0,g=d.length;h<g;h++){var f=d[h],l=n.get(f[0]);l[f[1]].apply(l,f[2])}else K(a)?b.push(n.invoke(a)):I(a)?b.push(n.invoke(a)):Oa(a,"module")}catch(m){throw I(a)&&(a=a[a.length-1]),m.message&&(m.stack&&-1==m.stack.indexOf(m.message))&&(m=m.message+"\n"+m.stack),Sa("modulerr",a,m.stack||m.message||m);}}});return b}function g(a,
...
e:c},get:c,annotate:fc,has:function(b){return m.hasOwnProperty(b+h)||a.hasOwnProperty(b)}}}var f={},h="Provider",l=[],k=new Ra,m={$provide:{provider:a(c),factory:a(d),service:a(function(a,b){return d(a,["$injector",function(a){return a.instantiate(b)}])}),value:a(function(a,b){return d(a,$(b))}),constant:a(function(a,b){wa(a,"constant");m[a]=b;p[a]=b}),decorator:function(a,b){var c=n.get(a+h),d=c.$get;c.$get=function(){var a=u.invoke(d,c);return u.invoke(b,null,{$delegate:a})}}}},n=m.$injector=g(m,
function(){throw Sa("unpr",l.join(" <- "));}),p={},u=p.$injector=g(p,function(a){a=n.get(a+h);return u.invoke(a.$get,a)});q(e(b),function(a){u.invoke(a||y)});return u}function bd(){var b=!0;this.disableAutoScrolling=function(){b=!1};this.$get=["$window","$location","$rootScope",function(a,c,d){function e(a){var b=null;q(a,function(a){b||"a"!==C(a.nodeName)||(b=a)});return b}function g(){var b=c.hash(),d;b?(d=f.getElementById(b))?d.scrollIntoView():(d=e(f.getElementsByName(b)))?d.scrollIntoView():
"top"===b&&a.scrollTo(0,0):a.scrollTo(0,0)}var f=a.document;b&&d.$watch(function(){return c.hash()},function(){d.$evalAsync(g)});return g}]}function cd(b,a,c,d){function e(a){try{a.apply(null,ua.call(arguments,1))}finally{if(t--,0===t)for(;A.length;)try{A.pop()()}catch(b){c.error(b)}}}function g(a,b){(function S(){q(F,function(a){a()});H=b(S,a)})()}function f(){B=null;Z!=h.url()&&(Z=h.url(),q(X,function(a){a(h.url())}))}var h=this,l=a[0],k=b.location,m=b.history,n=b.setTimeout,p=b.clearTimeout,u=
{};h.isMock=!1;var t=0,A=[];h.$$completeOutstandingRequest=e;h.$$incOutstandingRequestCount=function(){t++};h.notifyWhenNoOutstandingRequests=function(a){q(F,function(a){a()});0===t?a():A.push(a)};var F=[],H;h.addPollFn=function(a){D(H)&&g(100,n);F.push(a);return a};var Z=k.href,z=a.find("base"),B=null;h.url=function(a,c){k!==b.location&&(k=b.location);if(a){if(Z!=a)return Z=a,d.history?c?m.replaceState(null,"",a):(m.pushState(null,"",a),z.attr("href",z.attr("href"))):(B=a,c?k.replace(a):k.href=a),
h}else return B||k.href.replace(/%27/g,"'")};var X=[],M=!1;h.onUrlChange=function(a){if(!M){if(d.history)v(b).on("popstate",f);if(d.hashchange)v(b).on("hashchange",f);else h.addPollFn(f);M=!0}X.push(a);return a};h.baseHref=function(){var a=z.attr("href");return a?a.replace(/^https?\:\/\/[^\/]*/,""):""};var U={},ka="",Q=h.baseHref();h.cookies=function(a,b){var d,e,g,h;if(a)b===r?l.cookie=escape(a)+"=;path="+Q+";expires=Thu, 01 Jan 1970 00:00:00 GMT":E(b)&&(d=(l.cookie=escape(a)+"="+escape(b)+";path="+
Q).length+1,4096<d&&c.warn("Cookie '"+a+"' possibly not set or overflowed because it was too large ("+d+" > 4096 bytes)!"));else{if(l.cookie!==ka)for(ka=l.cookie,d=ka.split("; "),U={},g=0;g<d.length;g++)e=d[g],h=e.indexOf("="),0<h&&(a=unescape(e.substring(0,h)),U[a]===r&&(U[a]=unescape(e.substring(h+1))));return U}};h.defer=function(a,b){var c;t++;c=n(function(){delete u[c];e(a)},b||0);u[c]=!0;return c};h.defer.cancel=function(a){return u[a]?(delete u[a],p(a),e(y),!0):!1}}function dd(){this.$get=
...
{},d="Directive",e=/^\s*directive\:\s*([\d\w\-_]+)\s+(.*)$/,g=/(([\d\w\-_]+)(?:\:([^;]+))?;?)/,f=/^(on[a-z]+|formaction)$/;this.directive=function l(a,e){wa(a,"directive");E(a)?(sb(e,"directiveFactory"),c.hasOwnProperty(a)||(c[a]=[],b.factory(a+d,["$injector","$exceptionHandler",function(b,d){var e=[];q(c[a],function(c,g){try{var f=b.invoke(c);K(f)?f={compile:$(f)}:!f.compile&&f.link&&(f.compile=$(f.link));f.priority=f.priority||0;f.index=g;f.name=f.name||a;f.require=f.require||f.controller&&f.name;
f.restrict=f.restrict||"A";e.push(f)}catch(l){d(l)}});return e}])),c[a].push(e)):q(a,Ob(l));return this};this.aHrefSanitizationWhitelist=function(b){return w(b)?(a.aHrefSanitizationWhitelist(b),this):a.aHrefSanitizationWhitelist()};this.imgSrcSanitizationWhitelist=function(b){return w(b)?(a.imgSrcSanitizationWhitelist(b),this):a.imgSrcSanitizationWhitelist()};this.$get=["$injector","$interpolate","$exceptionHandler","$http","$templateCache","$parse","$controller","$rootScope","$document","$sce","$animate",
"$$sanitizeUri",function(a,b,m,n,p,u,t,A,F,H,Z,z){function B(a,b,c,d,e){a instanceof v||(a=v(a));q(a,function(b,c){3==b.nodeType&&b.nodeValue.match(/\S+/)&&(a[c]=v(b).wrap("<span></span>").parent()[0])});var g=M(a,b,a,c,d,e);X(a,"ng-scope");return function(b,c,d){sb(b,"scope");var e=c?Da.clone.call(a):a;q(d,function(a,b){e.data("$"+b+"Controller",a)});d=0;for(var f=e.length;d<f;d++){var k=e[d].nodeType;1!==k&&9!==k||e.eq(d).data("$scope",b)}c&&c(e,b);g&&g(b,e,e);return e}}function X(a,b){try{a.addClass(b)}catch(c){}}
function M(a,b,c,d,e,g){function f(a,c,d,e){var g,l,m,p,n,t,J;g=c.length;var u=Array(g);for(n=0;n<g;n++)u[n]=c[n];J=n=0;for(t=k.length;n<t;J++)l=u[J],c=k[n++],g=k[n++],m=v(l),c?(c.scope?(p=a.$new(),m.data("$scope",p)):p=a,(m=c.transclude)||!e&&b?c(g,p,l,d,U(a,m||b)):c(g,p,l,d,e)):g&&g(a,l.childNodes,r,e)}for(var k=[],l,m,p,n,t=0;t<a.length;t++)l=new Db,m=ka(a[t],[],l,0===t?d:r,e),(g=m.length?ga(m,a[t],l,b,c,null,[],[],g):null)&&g.scope&&X(v(a[t]),"ng-scope"),l=g&&g.terminal||!(p=a[t].childNodes)||
!p.length?null:M(p,g?g.transclude:b),k.push(g,l),n=n||g||l,g=null;return n?f:null}function U(a,b){return function(c,d,e){var g=!1;c||(c=a.$new(),g=c.$$transcluded=!0);d=b(c,d,e);if(g)d.on("$destroy",qb(c,c.$destroy));return d}}function ka(a,b,c,d,f){var k=c.$attr,l;switch(a.nodeType){case 1:S(b,la(Ea(a).toLowerCase()),"E",d,f);var m,p,n;l=a.attributes;for(var t=0,u=l&&l.length;t<u;t++){var A=!1,B=!1;m=l[t];if(!L||8<=L||m.specified){p=m.name;n=la(p);T.test(n)&&(p=ab(n.substr(6),"-"));var Z=n.replace(/(Start|End)$/,
"");n===Z+"Start"&&(A=p,B=p.substr(0,p.length-5)+"end",p=p.substr(0,p.length-6));n=la(p.toLowerCase());k[n]=p;c[n]=m=aa(m.value);dc(a,n)&&(c[n]=!0);P(a,b,m,n);S(b,n,"A",d,f,A,B)}}a=a.className;if(E(a)&&""!==a)for(;l=g.exec(a);)n=la(l[2]),S(b,n,"C",d,f)&&(c[n]=aa(l[3])),a=a.substr(l.index+l[0].length);break;case 3:s(b,a.nodeValue);break;case 8:try{if(l=e.exec(a.nodeValue))n=la(l[1]),S(b,n,"M",d,f)&&(c[n]=aa(l[2]))}catch(F){}}b.sort(D);return b}function Q(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ha("uterdir",
b,c);1==a.nodeType&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return v(d)}function R(a,b,c){return function(d,e,g,f,l){e=Q(e[0],b,c);return a(d,e,g,f,l)}}function ga(a,c,d,e,g,f,l,p,n){function A(a,b,c,d){if(a){c&&(a=R(a,c,d));a.require=G.require;if(z===G||G.$$isolateScope)a=ic(a,{isolateScope:!0});l.push(a)}if(b){c&&(b=R(b,c,d));b.require=G.require;if(z===G||G.$$isolateScope)b=ic(b,{isolateScope:!0});p.push(b)}}function Z(a,b,c){var d,e="data",
g=!1;if(E(a)){for(;"^"==(d=a.charAt(0))||"?"==d;)a=a.substr(1),"^"==d&&(e="inheritedData"),g=g||"?"==d;d=null;c&&"data"===e&&(d=c[a]);d=d||b[e]("$"+a+"Controller");if(!d&&!g)throw ha("ctreq",a,ba);}else I(a)&&(d=[],q(a,function(a){d.push(Z(a,b,c))}));return d}function F(a,e,g,f,n){function A(a,b){var c;2>arguments.length&&(b=a,a=r);D&&(c=eb);return n(a,b,c)}var J,B,U,M,R,Q,eb={},s;J=c===g?d:Rb(d,new Db(v(g),d.$attr));B=J.$$element;if(z){var ka=/^\s*([@=&])(\??)\s*(\w*)\s*$/;f=v(g);Q=e.$new(!0);ga&&
ga===z.$$originalDirective?f.data("$isolateScope",Q):f.data("$isolateScopeNoTemplate",Q);X(f,"ng-isolate-scope");q(z.scope,function(a,c){var d=a.match(ka)||[],g=d[3]||c,f="?"==d[2],d=d[1],l,m,n,p;Q.$$isolateBindings[c]=d+g;switch(d){case "@":J.$observe(g,function(a){Q[c]=a});J.$$observers[g].$$scope=e;J[g]&&(Q[c]=b(J[g])(e));break;case "=":if(f&&!J[g])break;m=u(J[g]);p=m.literal?ta:function(a,b){return a===b};n=m.assign||function(){l=Q[c]=m(e);throw ha("nonassign",J[g],z.name);};l=Q[c]=m(e);Q.$watch(function(){var a=
m(e);p(a,Q[c])||(p(a,l)?n(e,a=Q[c]):Q[c]=a);return l=a},null,m.literal);break;case "&":m=u(J[g]);Q[c]=function(a){return m(e,a)};break;default:throw ha("iscp",z.name,c,a);}})}s=n&&A;H&&q(H,function(a){var b={$scope:a===z||a.$$isolateScope?Q:e,$element:B,$attrs:J,$transclude:s},c;R=a.controller;"@"==R&&(R=J[a.name]);c=t(R,b);eb[a.name]=c;D||B.data("$"+a.name+"Controller",c);a.controllerAs&&(b.$scope[a.controllerAs]=c)});f=0;for(U=l.length;f<U;f++)try{M=l[f],M(M.isolateScope?Q:e,B,J,M.require&&Z(M.require,
B,eb),s)}catch(S){m(S,fa(B))}f=e;z&&(z.template||null===z.templateUrl)&&(f=Q);a&&a(f,g.childNodes,r,n);for(f=p.length-1;0<=f;f--)try{M=p[f],M(M.isolateScope?Q:e,B,J,M.require&&Z(M.require,B,eb),s)}catch(G){m(G,fa(B))}}n=n||{};var U=-Number.MAX_VALUE,M,H=n.controllerDirectives,z=n.newIsolateScopeDirective,ga=n.templateDirective;n=n.nonTlbTranscludeDirective;for(var S=!1,D=!1,x=d.$$element=v(c),G,ba,s,N=e,ma,L=0,Fa=a.length;L<Fa;L++){G=a[L];var P=G.$$start,T=G.$$end;P&&(x=Q(c,P,T));s=r;if(U>G.priority)break;
if(s=G.scope)M=M||G,G.templateUrl||(C("new/isolated scope",z,G,x),V(s)&&(z=G));ba=G.name;!G.templateUrl&&G.controller&&(s=G.controller,H=H||{},C("'"+ba+"' controller",H[ba],G,x),H[ba]=G);if(s=G.transclude)S=!0,G.$$tlb||(C("transclusion",n,G,x),n=G),"element"==s?(D=!0,U=G.priority,s=Q(c,P,T),x=d.$$element=v(O.createComment(" "+ba+": "+d[ba]+" ")),c=x[0],fb(g,v(ua.call(s,0)),c),N=B(s,e,U,f&&f.name,{nonTlbTranscludeDirective:n})):(s=v(yb(c)).contents(),x.empty(),N=B(s,e));if(G.template)if(C("template",
ga,G,x),ga=G,s=K(G.template)?G.template(x,d):G.template,s=W(s),G.replace){f=G;s=v("<div>"+aa(s)+"</div>").contents();c=s[0];if(1!=s.length||1!==c.nodeType)throw ha("tplrt",ba,"");fb(g,x,c);Fa={$attr:{}};s=ka(c,[],Fa);var Y=a.splice(L+1,a.length-(L+1));z&&gc(s);a=a.concat(s).concat(Y);w(d,Fa);Fa=a.length}else x.html(s);if(G.templateUrl)C("template",ga,G,x),ga=G,G.replace&&(f=G),F=y(a.splice(L,a.length-L),x,d,g,N,l,p,{controllerDirectives:H,newIsolateScopeDirective:z,templateDirective:ga,nonTlbTranscludeDirective:n}),
Fa=a.length;else if(G.compile)try{ma=G.compile(x,d,N),K(ma)?A(null,ma,P,T):ma&&A(ma.pre,ma.post,P,T)}catch($){m($,fa(x))}G.terminal&&(F.terminal=!0,U=Math.max(U,G.priority))}F.scope=M&&!0===M.scope;F.transclude=S&&N;return F}function gc(a){for(var b=0,c=a.length;b<c;b++)a[b]=Qb(a[b],{$$isolateScope:!0})}function S(b,e,g,f,k,n,p){if(e===k)return null;k=null;if(c.hasOwnProperty(e)){var t;e=a.get(e+d);for(var u=0,A=e.length;u<A;u++)try{t=e[u],(f===r||f>t.priority)&&-1!=t.restrict.indexOf(g)&&(n&&(t=
Qb(t,{$$start:n,$$end:p})),b.push(t),k=t)}catch(B){m(B)}}return k}function w(a,b){var c=b.$attr,d=a.$attr,e=a.$$element;q(a,function(d,e){"$"!=e.charAt(0)&&(b[e]&&(d+=("style"===e?";":" ")+b[e]),a.$set(e,d,!0,c[e]))});q(b,function(b,g){"class"==g?(X(e,b),a["class"]=(a["class"]?a["class"]+" ":"")+b):"style"==g?(e.attr("style",e.attr("style")+";"+b),a.style=(a.style?a.style+";":"")+b):"$"==g.charAt(0)||a.hasOwnProperty(g)||(a[g]=b,d[g]=c[g])})}function y(a,b,c,d,e,g,f,l){var k=[],m,t,u=b[0],A=a.shift(),
B=x({},A,{templateUrl:null,transclude:null,replace:null,$$originalDirective:A}),Z=K(A.templateUrl)?A.templateUrl(b,c):A.templateUrl;b.empty();n.get(H.getTrustedResourceUrl(Z),{cache:p}).success(function(n){var p,F;n=W(n);if(A.replace){n=v("<div>"+aa(n)+"</div>").contents();p=n[0];if(1!=n.length||1!==p.nodeType)throw ha("tplrt",A.name,Z);n={$attr:{}};fb(d,b,p);var X=ka(p,[],n);V(A.scope)&&gc(X);a=X.concat(a);w(c,n)}else p=u,b.html(n);a.unshift(B);m=ga(a,p,c,e,b,A,g,f,l);q(d,function(a,c){a==p&&(d[c]=
b[0])});for(t=M(b[0].childNodes,e);k.length;){n=k.shift();F=k.shift();var z=k.shift(),H=k.shift(),X=b[0];F!==u&&(X=yb(p),fb(z,v(F),X));F=m.transclude?U(n,m.transclude):H;m(t,n,X,d,F)}k=null}).error(function(a,b,c,d){throw ha("tpload",d.url);});return function(a,b,c,d,e){k?(k.push(b),k.push(c),k.push(d),k.push(e)):m(t,b,c,d,e)}}function D(a,b){var c=b.priority-a.priority;return 0!==c?c:a.name!==b.name?a.name<b.name?-1:1:a.index-b.index}function C(a,b,c,d){if(b)throw ha("multidir",b.name,c.name,a,fa(d));
}function s(a,c){var d=b(c,!0);d&&a.push({priority:0,compile:$(function(a,b){var c=b.parent(),e=c.data("$binding")||[];e.push(d);X(c.data("$binding",e),"ng-binding");a.$watch(d,function(a){b[0].nodeValue=a})})})}function N(a,b){if("srcdoc"==b)return H.HTML;var c=Ea(a);if("xlinkHref"==b||"FORM"==c&&"action"==b||"IMG"!=c&&("src"==b||"ngSrc"==b))return H.RESOURCE_URL}function P(a,c,d,e){var g=b(d,!0);if(g){if("multiple"===e&&"SELECT"===Ea(a))throw ha("selmulti",fa(a));c.push({priority:100,compile:function(){return{pre:function(c,
...
a.appendChild(d);c[v.expando]=d[v.expando];d=1;for(e=b.length;d<e;d++)g=b[d],v(g).remove(),a.appendChild(g),delete b[d];b[0]=c;b.length=1}function ic(a,b){return x(function(){return a.apply(null,arguments)},a,b)}var Db=function(a,b){this.$$element=a;this.$attr=b||{}};Db.prototype={$normalize:la,$addClass:function(a){a&&0<a.length&&Z.addClass(this.$$element,a)},$removeClass:function(a){a&&0<a.length&&Z.removeClass(this.$$element,a)},$updateClass:function(a,b){this.$removeClass(jc(b,a));this.$addClass(jc(a,
...
A.$evalAsync(function(){e.$$inter||b(c[a])});return b}};var ba=b.startSymbol(),ma=b.endSymbol(),W="{{"==ba||"}}"==ma?za:function(a){return a.replace(/\{\{/g,ba).replace(/}}/g,ma)},T=/^ngAttr[A-Z]/;return B}]}function la(b){return Pa(b.replace(gd,""))}function jc(b,a){var c="",d=b.split(/\s+/),e=a.split(/\s+/),g=0;a:for(;g<d.length;g++){for(var f=d[g],h=0;h<e.length;h++)if(f==e[h])continue a;c+=(0<c.length?" ":"")+f}return c}function hd(){var b={},a=/^(\S+)(\s+as\s+(\w+))?$/;this.register=function(a,
d){wa(a,"controller");V(a)?x(b,a):b[a]=d};this.$get=["$injector","$window",function(c,d){return function(e,g){var f,h,l;E(e)&&(f=e.match(a),h=f[1],l=f[3],e=b.hasOwnProperty(h)?b[h]:tb(g.$scope,h,!0)||tb(d,h,!0),Oa(e,h,!0));f=c.instantiate(e,g);if(l){if(!g||"object"!=typeof g.$scope)throw s("$controller")("noscp",h||e.name,l);g.$scope[l]=f}return f}}]}function id(){this.$get=["$window",function(b){return v(b.document)}]}function jd(){this.$get=["$log",function(b){return function(a,c){b.error.apply(b,
arguments)}}]}function kc(b){var a={},c,d,e;if(!b)return a;q(b.split("\n"),function(b){e=b.indexOf(":");c=C(aa(b.substr(0,e)));d=aa(b.substr(e+1));c&&(a[c]=a[c]?a[c]+(", "+d):d)});return a}function lc(b){var a=V(b)?b:r;return function(c){a||(a=kc(b));return c?a[C(c)]||null:a}}function mc(b,a,c){if(K(c))return c(b,a);q(c,function(c){b=c(b,a)});return b}function kd(){var b=/^\s*(\[|\{[^\{])/,a=/[\}\]]\s*$/,c=/^\)\]\}',?\n/,d={"Content-Type":"application/json;charset=utf-8"},e=this.defaults={transformResponse:[function(d){E(d)&&
(d=d.replace(c,""),b.test(d)&&a.test(d)&&(d=Tb(d)));return d}],transformRequest:[function(a){return V(a)&&"[object File]"!==Ya.call(a)?oa(a):a}],headers:{common:{Accept:"application/json, text/plain, */*"},post:d,put:d,patch:d},xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN"},g=this.interceptors=[],f=this.responseInterceptors=[];this.$get=["$httpBackend","$browser","$cacheFactory","$rootScope","$q","$injector",function(a,b,c,d,n,p){function u(a){function c(a){var b=x({},a,{data:mc(a.data,
...
e.xsrfCookieName]:r)&&(g[d.xsrfHeaderName||e.xsrfHeaderName]=a);var f=[function(a){g=a.headers;var b=mc(a.data,lc(g),a.transformRequest);D(a.data)&&q(g,function(a,b){"content-type"===C(b)&&delete g[b]});D(a.withCredentials)&&!D(e.withCredentials)&&(a.withCredentials=e.withCredentials);return t(a,b,g).then(c,c)},r],h=n.when(d);for(q(H,function(a){(a.request||a.requestError)&&f.unshift(a.request,a.requestError);(a.response||a.responseError)&&f.push(a.response,a.responseError)});f.length;){a=f.shift();
var k=f.shift(),h=h.then(a,k)}h.success=function(a){h.then(function(b){a(b.data,b.status,b.headers,d)});return h};h.error=function(a){h.then(null,function(b){a(b.data,b.status,b.headers,d)});return h};return h}function t(b,c,g){function f(a,b,c){q&&(200<=a&&300>a?q.put(r,[a,b,kc(c)]):q.remove(r));l(b,a,c);d.$$phase||d.$apply()}function l(a,c,d){c=Math.max(c,0);(200<=c&&300>c?p.resolve:p.reject)({data:a,status:c,headers:lc(d),config:b})}function k(){var a=$a(u.pendingRequests,b);-1!==a&&u.pendingRequests.splice(a,
1)}var p=n.defer(),t=p.promise,q,H,r=A(b.url,b.params);u.pendingRequests.push(b);t.then(k,k);(b.cache||e.cache)&&(!1!==b.cache&&"GET"==b.method)&&(q=V(b.cache)?b.cache:V(e.cache)?e.cache:F);if(q)if(H=q.get(r),w(H)){if(H.then)return H.then(k,k),H;I(H)?l(H[1],H[0],ea(H[2])):l(H,200,{})}else q.put(r,t);D(H)&&a(b.method,r,c,f,g,b.timeout,b.withCredentials,b.responseType);return t}function A(a,b){if(!b)return a;var c=[];Nc(b,function(a,b){null===a||D(a)||(I(a)||(a=[a]),q(a,function(a){V(a)&&(a=oa(a));
c.push(va(b)+"="+va(a))}))});return a+(-1==a.indexOf("?")?"?":"&")+c.join("&")}var F=c("$http"),H=[];q(g,function(a){H.unshift(E(a)?p.get(a):p.invoke(a))});q(f,function(a,b){var c=E(a)?p.get(a):p.invoke(a);H.splice(b,0,{response:function(a){return c(n.when(a))},responseError:function(a){return c(n.reject(a))}})});u.pendingRequests=[];(function(a){q(arguments,function(a){u[a]=function(b,c){return u(x(c||{},{method:a,url:b}))}})})("get","delete","head","jsonp");(function(a){q(arguments,function(a){u[a]=
function(b,c,d){return u(x(d||{},{method:a,url:b,data:c}))}})})("post","put");u.defaults=e;return u}]}function ld(){this.$get=["$browser","$window","$document",function(b,a,c){return md(b,nd,b.defer,a.angular.callbacks,c[0])}]}function md(b,a,c,d,e){function g(a,b){var c=e.createElement("script"),d=function(){c.onreadystatechange=c.onload=c.onerror=null;e.body.removeChild(c);b&&b()};c.type="text/javascript";c.src=a;L&&8>=L?c.onreadystatechange=function(){/loaded|complete/.test(c.readyState)&&d()}:
c.onload=c.onerror=function(){d()};e.body.appendChild(c);return d}var f=-1;return function(e,l,k,m,n,p,u,t){function A(){H=f;z&&z();B&&B.abort()}function F(a,d,e,g){var f=pa(l).protocol;X&&c.cancel(X);z=B=null;d="file"==f&&0===d?e?200:404:d;a(1223==d?204:d,e,g);b.$$completeOutstandingRequest(y)}var H;b.$$incOutstandingRequestCount();l=l||b.url();if("jsonp"==C(e)){var r="_"+(d.counter++).toString(36);d[r]=function(a){d[r].data=a};var z=g(l.replace("JSON_CALLBACK","angular.callbacks."+r),function(){d[r].data?
F(m,200,d[r].data):F(m,H||-2);delete d[r]})}else{var B=new a;B.open(e,l,!0);q(n,function(a,b){w(a)&&B.setRequestHeader(b,a)});B.onreadystatechange=function(){if(4==B.readyState){var a=null,b=null;H!==f&&(a=B.getAllResponseHeaders(),b=B.responseType?B.response:B.responseText);F(m,H||B.status,b,a)}};u&&(B.withCredentials=!0);t&&(B.responseType=t);B.send(k||null)}if(0<p)var X=c(A,p);else p&&p.then&&p.then(A)}}function od(){var b="{{",a="}}";this.startSymbol=function(a){return a?(b=a,this):b};this.endSymbol=
function(b){return b?(a=b,this):a};this.$get=["$parse","$exceptionHandler","$sce",function(c,d,e){function g(g,k,m){for(var n,p,u=0,t=[],A=g.length,F=!1,q=[];u<A;)-1!=(n=g.indexOf(b,u))&&-1!=(p=g.indexOf(a,n+f))?(u!=n&&t.push(g.substring(u,n)),t.push(u=c(F=g.substring(n+f,p))),u.exp=F,u=p+h,F=!0):(u!=A&&t.push(g.substring(u)),u=A);(A=t.length)||(t.push(""),A=1);if(m&&1<t.length)throw nc("noconcat",g);if(!k||F)return q.length=A,u=function(a){try{for(var b=0,c=A,f;b<c;b++)"function"==typeof(f=t[b])&&
(f=f(a),f=m?e.getTrusted(m,f):e.valueOf(f),null===f||D(f)?f="":"string"!=typeof f&&(f=oa(f))),q[b]=f;return q.join("")}catch(h){a=nc("interr",g,h.toString()),d(a)}},u.exp=g,u.parts=t,u}var f=b.length,h=a.length;g.startSymbol=function(){return b};g.endSymbol=function(){return a};return g}]}function pd(){this.$get=["$rootScope","$window","$q",function(b,a,c){function d(d,f,h,l){var k=a.setInterval,m=a.clearInterval,n=c.defer(),p=n.promise,u=0,t=w(l)&&!l;h=w(h)?h:0;p.then(null,null,d);p.$$intervalId=
k(function(){n.notify(u++);0<h&&u>=h&&(n.resolve(u),m(p.$$intervalId),delete e[p.$$intervalId]);t||b.$apply()},f);e[p.$$intervalId]=n;return p}var e={};d.cancel=function(a){return a&&a.$$intervalId in e?(e[a.$$intervalId].reject("canceled"),clearInterval(a.$$intervalId),delete e[a.$$intervalId],!0):!1};return d}]}function qd(){this.$get=function(){return{id:"en-us",NUMBER_FORMATS:{DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{minInt:1,minFrac:0,maxFrac:3,posPre:"",posSuf:"",negPre:"-",negSuf:"",gSize:3,
...
if(e=na(c,d))return b+a+e;if(c===d+"/")return c}}function gb(b){return function(){return this[b]}}function tc(b,a){return function(c){if(D(c))return this[b];this[b]=a(c);this.$$compose();return this}}function sd(){var b="",a=!1;this.hashPrefix=function(a){return w(a)?(b=a,this):b};this.html5Mode=function(b){return w(b)?(a=b,this):a};this.$get=["$rootScope","$browser","$sniffer","$rootElement",function(c,d,e,g){function f(a){c.$broadcast("$locationChangeSuccess",h.absUrl(),a)}var h,l=d.baseHref(),
k=d.url();a?(l=k.substring(0,k.indexOf("/",k.indexOf("//")+2))+(l||"/"),e=e.history?rc:sc):(l=Ua(k),e=Hb);h=new e(l,"#"+b);h.$$parse(h.$$rewrite(k));g.on("click",function(a){if(!a.ctrlKey&&!a.metaKey&&2!=a.which){for(var b=v(a.target);"a"!==C(b[0].nodeName);)if(b[0]===g[0]||!(b=b.parent())[0])return;var e=b.prop("href");V(e)&&"[object SVGAnimatedString]"===e.toString()&&(e=pa(e.animVal).href);var f=h.$$rewrite(e);e&&(!b.attr("target")&&f&&!a.isDefaultPrevented())&&(a.preventDefault(),f!=d.url()&&
...
(d.url(h.absUrl(),b),f(a))}));h.$$replace=!1;return m});return h}]}function td(){var b=!0,a=this;this.debugEnabled=function(a){return w(a)?(b=a,this):b};this.$get=["$window",function(c){function d(a){a instanceof Error&&(a.stack?a=a.message&&-1===a.stack.indexOf(a.message)?"Error: "+a.message+"\n"+a.stack:a.stack:a.sourceURL&&(a=a.message+"\n"+a.sourceURL+":"+a.line));return a}function e(a){var b=c.console||{},e=b[a]||b.log||y;a=!1;try{a=!!e.apply}catch(l){}return a?function(){var a=[];q(arguments,
...
var f=f+"return s;",h=new Function("s","k","pw",f);h.toString=$(f);g=a.unwrapPromises?function(a,b){return h(a,b,qa)}:h}else g=vd(d[0],d[1],c);else g=ud(d[0],c);"hasOwnProperty"!==b&&(Ib[b]=g);return g}function wd(){var b={},a={csp:!1,unwrapPromises:!1,logPromiseWarnings:!0};this.unwrapPromises=function(b){return w(b)?(a.unwrapPromises=!!b,this):a.unwrapPromises};this.logPromiseWarnings=function(b){return w(b)?(a.logPromiseWarnings=b,this):a.logPromiseWarnings};this.$get=["$filter","$sniffer","$log",
...
function(b,a){return yd(function(a){b.$evalAsync(a)},a)}]}function yd(b,a){function c(a){return a}function d(a){return f(a)}var e=function(){var h=[],l,k;return k={resolve:function(a){if(h){var c=h;h=r;l=g(a);c.length&&b(function(){for(var a,b=0,d=c.length;b<d;b++)a=c[b],l.then(a[0],a[1],a[2])})}},reject:function(a){k.resolve(f(a))},notify:function(a){if(h){var c=h;h.length&&b(function(){for(var b,d=0,e=c.length;d<e;d++)b=c[d],b[2](a)})}},promise:{then:function(b,g,f){var k=e(),t=function(d){try{k.resolve((K(b)?
b:c)(d))}catch(e){k.reject(e),a(e)}},A=function(b){try{k.resolve((K(g)?g:d)(b))}catch(c){k.reject(c),a(c)}},F=function(b){try{k.notify((K(f)?f:c)(b))}catch(d){a(d)}};h?h.push([t,A,F]):l.then(t,A,F);return k.promise},"catch":function(a){return this.then(null,a)},"finally":function(a){function b(a,c){var d=e();c?d.resolve(a):d.reject(a);return d.promise}function d(e,g){var f=null;try{f=(a||c)()}catch(h){return b(h,!1)}return f&&K(f.then)?f.then(function(){return b(e,g)},function(a){return b(a,!1)}):
b(e,g)}return this.then(function(a){return d(a,!0)},function(a){return d(a,!1)})}}}},g=function(a){return a&&K(a.then)?a:{then:function(c){var d=e();b(function(){d.resolve(c(a))});return d.promise}}},f=function(c){return{then:function(g,f){var m=e();b(function(){try{m.resolve((K(f)?f:d)(c))}catch(b){m.reject(b),a(b)}});return m.promise}}};return{defer:e,reject:f,when:function(h,l,k,m){var n=e(),p,u=function(b){try{return(K(l)?l:c)(b)}catch(d){return a(d),f(d)}},t=function(b){try{return(K(k)?k:d)(b)}catch(c){return a(c),
f(c)}},A=function(b){try{return(K(m)?m:c)(b)}catch(d){a(d)}};b(function(){g(h).then(function(a){p||(p=!0,n.resolve(g(a).then(u,t,A)))},function(a){p||(p=!0,n.resolve(t(a)))},function(a){p||n.notify(A(a))})});return n.promise},all:function(a){var b=e(),c=0,d=I(a)?[]:{};q(a,function(a,e){c++;g(a).then(function(a){d.hasOwnProperty(e)||(d[e]=a,--c||b.resolve(d))},function(a){d.hasOwnProperty(e)||b.reject(a)})});0===c&&b.resolve(d);return b.promise}}}function zd(){var b=10,a=s("$rootScope"),c=null;this.digestTtl=
...
b,d){var e=k(a,"watch"),g=this.$$watchers,f={fn:b,last:m,get:e,exp:a,eq:!!d};c=null;if(!K(b)){var h=k(b||y,"listener");f.fn=function(a,b,c){h(c)}}if("string"==typeof a&&e.constant){var l=f.fn;f.fn=function(a,b,c){l.call(this,a,b,c);Ka(g,f)}}g||(g=this.$$watchers=[]);g.unshift(f);return function(){Ka(g,f)}},$watchCollection:function(a,b){var c=this,d,e,f=0,h=g(a),l=[],k={},m=0;return this.$watch(function(){e=h(c);var a,b;if(V(e))if(ob(e))for(d!==l&&(d=l,m=d.length=0,f++),a=e.length,m!==a&&(f++,d.length=
m=a),b=0;b<a;b++)d[b]!==e[b]&&(f++,d[b]=e[b]);else{d!==k&&(d=k={},m=0,f++);a=0;for(b in e)e.hasOwnProperty(b)&&(a++,d.hasOwnProperty(b)?d[b]!==e[b]&&(f++,d[b]=e[b]):(m++,d[b]=e[b],f++));if(m>a)for(b in f++,d)d.hasOwnProperty(b)&&!e.hasOwnProperty(b)&&(m--,delete d[b])}else d!==e&&(d=e,f++);return f},function(){b(e,d,c)})},$digest:function(){var d,f,g,h,k=this.$$asyncQueue,q=this.$$postDigestQueue,r,z,B=b,s,M=[],U,v,w;l("$digest");c=null;do{z=!1;for(s=this;k.length;){try{w=k.shift(),w.scope.$eval(w.expression)}catch(R){n.$$phase=
null,e(R)}c=null}a:do{if(h=s.$$watchers)for(r=h.length;r--;)try{if(d=h[r])if((f=d.get(s))!==(g=d.last)&&!(d.eq?ta(f,g):"number"==typeof f&&"number"==typeof g&&isNaN(f)&&isNaN(g)))z=!0,c=d,d.last=d.eq?ea(f):f,d.fn(f,g===m?f:g,s),5>B&&(U=4-B,M[U]||(M[U]=[]),v=K(d.exp)?"fn: "+(d.exp.name||d.exp.toString()):d.exp,v+="; newVal: "+oa(f)+"; oldVal: "+oa(g),M[U].push(v));else if(d===c){z=!1;break a}}catch(x){n.$$phase=null,e(x)}if(!(h=s.$$childHead||s!==this&&s.$$nextSibling))for(;s!==this&&!(h=s.$$nextSibling);)s=
...
a in b}return c[a]},csp:Sb(),vendorPrefix:h,transitions:m,animations:n,android:d,msie:L,msieDocumentMode:f}}]}function Fd(){this.$get=["$rootScope","$browser","$q","$exceptionHandler",function(b,a,c,d){function e(e,h,l){var k=c.defer(),m=k.promise,n=w(l)&&!l;h=a.defer(function(){try{k.resolve(e())}catch(a){k.reject(a),d(a)}finally{delete g[m.$$timeoutId]}n||b.$apply()},h);m.$$timeoutId=h;g[h]=k;return m}var g={};e.cancel=function(b){return b&&b.$$timeoutId in g?(g[b.$$timeoutId].reject("canceled"),
delete g[b.$$timeoutId],a.defer.cancel(b.$$timeoutId)):!1};return e}]}function pa(b,a){var c=b;L&&(W.setAttribute("href",c),c=W.href);W.setAttribute("href",c);return{href:W.href,protocol:W.protocol?W.protocol.replace(/:$/,""):"",host:W.host,search:W.search?W.search.replace(/^\?/,""):"",hash:W.hash?W.hash.replace(/^#/,""):"",hostname:W.hostname,port:W.port,pathname:"/"===W.pathname.charAt(0)?W.pathname:"/"+W.pathname}}function Eb(b){b=E(b)?pa(b):b;return b.protocol===yc.protocol&&b.host===yc.host}
function Gd(){this.$get=$(Y)}function zc(b){function a(d,e){if(V(d)){var g={};q(d,function(b,c){g[c]=a(c,b)});return g}return b.factory(d+c,e)}var c="Filter";this.register=a;this.$get=["$injector",function(a){return function(b){return a.get(b+c)}}];a("currency",Ac);a("date",Bc);a("filter",Hd);a("json",Id);a("limitTo",Jd);a("lowercase",Kd);a("number",Cc);a("orderBy",Dc);a("uppercase",Ld)}function Hd(){return function(b,a,c){if(!I(b))return b;var d=typeof c,e=[];e.check=function(a){for(var b=0;b<e.length;b++)if(!e[b](a))return!1;
...
a||1;return this.index+a<this.text.length?this.text.charAt(this.index+a):!1},isNumber:function(a){return"0"<=a&&"9">=a},isWhitespace:function(a){return" "===a||"\r"===a||"\t"===a||"\n"===a||"\v"===a||"\u00a0"===a},isIdent:function(a){return"a"<=a&&"z">=a||"A"<=a&&"Z">=a||"_"===a||"$"===a},isExpOperator:function(a){return"-"===a||"+"===a||this.isNumber(a)},throwError:function(a,c,d){d=d||this.index;c=w(c)?"s "+c+"-"+this.index+" ["+this.text.substring(c,d)+"]":" "+d;throw xa("lexerr",a,c,this.text);
...
a.push({key:d,value:e});e.constant||(c=!1)}while(this.expect(","))}this.consume("}");return x(function(c,d){for(var e={},l=0;l<a.length;l++){var k=a[l];e[k.key]=k.value(c,d)}return e},{literal:!0,constant:c})}};var Ib={},ra=s("$sce"),da={HTML:"html",CSS:"css",URL:"url",RESOURCE_URL:"resourceUrl",JS:"js"},W=O.createElement("a"),yc=pa(Y.location.href,!0);zc.$inject=["$provide"];Ac.$inject=["$locale"];Cc.$inject=["$locale"];var Fc=".",Od={yyyy:T("FullYear",4),yy:T("FullYear",2,0,!0),y:T("FullYear",1),
MMMM:ib("Month"),MMM:ib("Month",!0),MM:T("Month",2,1),M:T("Month",1,1),dd:T("Date",2),d:T("Date",1),HH:T("Hours",2),H:T("Hours",1),hh:T("Hours",2,-12),h:T("Hours",1,-12),mm:T("Minutes",2),m:T("Minutes",1),ss:T("Seconds",2),s:T("Seconds",1),sss:T("Milliseconds",3),EEEE:ib("Day"),EEE:ib("Day",!0),a:function(a,c){return 12>a.getHours()?c.AMPMS[0]:c.AMPMS[1]},Z:function(a){a=-1*a.getTimezoneOffset();return a=(0<=a?"+":"")+(Kb(Math[0<a?"floor":"ceil"](a/60),2)+Kb(Math.abs(a%60),2))}},Nd=/((?:[^yMdHhmsaZE']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z))(.*)/,
Md=/^\-?\d+$/;Bc.$inject=["$locale"];var Kd=$(C),Ld=$(Ga);Dc.$inject=["$parse"];var Vd=$({restrict:"E",compile:function(a,c){8>=L&&(c.href||c.name||c.$set("href",""),a.append(O.createComment("IE fix")));if(!c.href&&!c.name)return function(a,c){c.on("click",function(a){c.attr("href")||a.preventDefault()})}}}),Mb={};q(db,function(a,c){if("multiple"!=a){var d=la("ng-"+c);Mb[d]=function(){return{priority:100,compile:function(){return function(a,g,f){a.$watch(f[d],function(a){f.$set(c,!!a)})}}}}}});q(["src",
...
e.$viewValue};e.$isEmpty=function(a){return a!==g};e.$formatters.push(function(a){return a===g});e.$parsers.push(function(a){return a?g:f})},hidden:y,button:y,submit:y,reset:y},Kc=["$browser","$sniffer",function(a,c){return{restrict:"E",require:"?ngModel",link:function(d,e,g,f){f&&(Jc[C(g.type)]||Jc.text)(d,e,g,f,c,a)}}}],kb="ng-valid",jb="ng-invalid",Ha="ng-pristine",mb="ng-dirty",ae=["$scope","$exceptionHandler","$attrs","$element","$parse","$interpolate",function(a,c,d,e,g,f){function h(a,c){c=
c?"-"+ab(c,"-"):"";e.removeClass((a?jb:kb)+c).addClass((a?kb:jb)+c)}this.$modelValue=this.$viewValue=Number.NaN;this.$parsers=[];this.$formatters=[];this.$viewChangeListeners=[];this.$pristine=!0;this.$dirty=!1;this.$valid=!0;this.$invalid=!1;this.$name=f(d.name||"")(a)||r;var l=g(d.ngModel),k=l.assign;if(!k)throw s("ngModel")("nonassign",d.ngModel,fa(e));this.$render=y;this.$isEmpty=function(a){return D(a)||""===a||null===a||a!==a};var m=e.inheritedData("$formController")||lb,n=0,p=this.$error={};
e.addClass(Ha);h(!0);this.$setValidity=function(a,c){p[a]!==!c&&(c?(p[a]&&n--,n||(h(!0),this.$valid=!0,this.$invalid=!1)):(h(!1),this.$invalid=!0,this.$valid=!1,n++),p[a]=!c,h(c,a),m.$setValidity(a,c,this))};this.$setPristine=function(){this.$dirty=!1;this.$pristine=!0;e.removeClass(mb).addClass(Ha)};this.$setViewValue=function(d){this.$viewValue=d;this.$pristine&&(this.$dirty=!0,this.$pristine=!1,e.removeClass(Ha).addClass(mb),m.$setDirty());q(this.$parsers,function(a){d=a(d)});this.$modelValue!==
d&&(this.$modelValue=d,k(a,d),q(this.$viewChangeListeners,function(a){try{a()}catch(d){c(d)}}))};var u=this;a.$watch(function(){var c=l(a);if(u.$modelValue!==c){var d=u.$formatters,e=d.length;for(u.$modelValue=c;e--;)c=d[e](c);u.$viewValue!==c&&(u.$viewValue=c,u.$render())}return c})}],be=function(){return{require:["ngModel","^?form"],controller:ae,link:function(a,c,d,e){var g=e[0],f=e[1]||lb;f.$addControl(g);a.$on("$destroy",function(){f.$removeControl(g)})}}},ce=$({require:"ngModel",link:function(a,
...
d.ngBind);a.$watch(d.ngBind,function(a){c.text(a==r?"":a)})}),he=["$interpolate",function(a){return function(c,d,e){c=a(d.attr(e.$attr.ngBindTemplate));d.addClass("ng-binding").data("$binding",c);e.$observe("ngBindTemplate",function(a){d.text(a)})}}],ie=["$sce","$parse",function(a,c){return function(d,e,g){e.addClass("ng-binding").data("$binding",g.ngBindHtml);var f=c(g.ngBindHtml);d.$watch(function(){return(f(d)||"").toString()},function(c){e.html(a.getTrustedHtml(f(d))||"")})}}],je=Lb("",!0),ke=
Lb("Odd",0),le=Lb("Even",1),me=sa({compile:function(a,c){c.$set("ngCloak",r);a.removeClass("ng-cloak")}}),ne=[function(){return{scope:!0,controller:"@",priority:500}}],Mc={};q("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),function(a){var c=la("ng-"+a);Mc[c]=["$parse",function(d){return{compile:function(e,g){var f=d(g[c]);return function(c,d,e){d.on(C(a),function(a){c.$apply(function(){f(c,{$event:a})})})}}}}]});
var oe=["$animate",function(a){return{transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(c,d,e,g,f){var h,l;c.$watch(e.ngIf,function(g){Ma(g)?l||(l=c.$new(),f(l,function(c){c[c.length++]=O.createComment(" end ngIf: "+e.ngIf+" ");h={clone:c};a.enter(c,d.parent(),d)})):(l&&(l.$destroy(),l=null),h&&(a.leave(ub(h.clone)),h=null))})}}}],pe=["$http","$templateCache","$anchorScroll","$animate","$sce",function(a,c,d,e,g){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",
controller:Na.noop,compile:function(f,h){var l=h.ngInclude||h.src,k=h.onload||"",m=h.autoscroll;return function(f,h,q,r,A){var s=0,v,x,z=function(){v&&(v.$destroy(),v=null);x&&(e.leave(x),x=null)};f.$watch(g.parseAsResourceUrl(l),function(g){var l=function(){!w(m)||m&&!f.$eval(m)||d()},q=++s;g?(a.get(g,{cache:c}).success(function(a){if(q===s){var c=f.$new();r.template=a;a=A(c,function(a){z();e.enter(a,null,h,l)});v=c;x=a;v.$emit("$includeContentLoaded");f.$eval(k)}}).error(function(){q===s&&z()}),
f.$emit("$includeContentRequested")):(z(),r.template=null)})}}}}],qe=["$compile",function(a){return{restrict:"ECA",priority:-400,require:"ngInclude",link:function(c,d,e,g){d.html(g.template);a(d.contents())(c)}}}],re=sa({priority:450,compile:function(){return{pre:function(a,c,d){a.$eval(d.ngInit)}}}}),se=sa({terminal:!0,priority:1E3}),te=["$locale","$interpolate",function(a,c){var d=/{}/g;return{restrict:"EA",link:function(e,g,f){var h=f.count,l=f.$attr.when&&g.attr(f.$attr.when),k=f.offset||0,m=
e.$eval(l)||{},n={},p=c.startSymbol(),u=c.endSymbol(),r=/^when(Minus)?(.+)$/;q(f,function(a,c){r.test(c)&&(m[C(c.replace("when","").replace("Minus","-"))]=g.attr(f.$attr[c]))});q(m,function(a,e){n[e]=c(a.replace(d,p+h+"-"+k+u))});e.$watch(function(){var c=parseFloat(e.$eval(h));if(isNaN(c))return"";c in m||(c=a.pluralCat(c-k));return n[c](e,g,!0)},function(a){g.text(a)})}}}],ue=["$parse","$animate",function(a,c){var d=s("ngRepeat");return{transclude:"element",priority:1E3,terminal:!0,$$tlb:!0,link:function(e,
g,f,h,l){var k=f.ngRepeat,m=k.match(/^\s*(.+)\s+in\s+([\r\n\s\S]*?)\s*(\s+track\s+by\s+(.+)\s*)?$/),n,p,r,t,s,x,w={$id:Ca};if(!m)throw d("iexp",k);f=m[1];h=m[2];(m=m[4])?(n=a(m),p=function(a,c,d){x&&(w[x]=a);w[s]=c;w.$index=d;return n(e,w)}):(r=function(a,c){return Ca(c)},t=function(a){return a});m=f.match(/^(?:([\$\w]+)|\(([\$\w]+)\s*,\s*([\$\w]+)\))$/);if(!m)throw d("iidexp",f);s=m[3]||m[1];x=m[2];var D={};e.$watchCollection(h,function(a){var f,h,m=g[0],n,w={},H,R,E,y,S,C,I=[];if(ob(a))S=a,n=p||
r;else{n=p||t;S=[];for(E in a)a.hasOwnProperty(E)&&"$"!=E.charAt(0)&&S.push(E);S.sort()}H=S.length;h=I.length=S.length;for(f=0;f<h;f++)if(E=a===S?f:S[f],y=a[E],y=n(E,y,f),wa(y,"`track by` id"),D.hasOwnProperty(y))C=D[y],delete D[y],w[y]=C,I[f]=C;else{if(w.hasOwnProperty(y))throw q(I,function(a){a&&a.scope&&(D[a.id]=a)}),d("dupes",k,y);I[f]={id:y};w[y]=!1}for(E in D)D.hasOwnProperty(E)&&(C=D[E],f=ub(C.clone),c.leave(f),q(f,function(a){a.$$NG_REMOVED=!0}),C.scope.$destroy());f=0;for(h=S.length;f<h;f++){E=
a===S?f:S[f];y=a[E];C=I[f];I[f-1]&&(m=I[f-1].clone[I[f-1].clone.length-1]);if(C.scope){R=C.scope;n=m;do n=n.nextSibling;while(n&&n.$$NG_REMOVED);C.clone[0]!=n&&c.move(ub(C.clone),null,v(m));m=C.clone[C.clone.length-1]}else R=e.$new();R[s]=y;x&&(R[x]=E);R.$index=f;R.$first=0===f;R.$last=f===H-1;R.$middle=!(R.$first||R.$last);R.$odd=!(R.$even=0===(f&1));C.scope||l(R,function(a){a[a.length++]=O.createComment(" end ngRepeat: "+k+" ");c.enter(a,null,v(m));m=a;C.scope=R;C.clone=a;w[C.id]=C})}D=w})}}}],
...
d,e,g){var f,h,l=[];c.$watch(e.ngSwitch||e.on,function(d){for(var m=0,n=l.length;m<n;m++)l[m].$destroy(),a.leave(h[m]);h=[];l=[];if(f=g.cases["!"+d]||g.cases["?"])c.$eval(e.change),q(f,function(d){var e=c.$new();l.push(e);d.transclude(e,function(c){var e=d.element;h.push(c);a.enter(c,e.parent(),e)})})})}}}],ze=sa({transclude:"element",priority:800,require:"^ngSwitch",compile:function(a,c){return function(a,e,g,f,h){f.cases["!"+c.ngSwitchWhen]=f.cases["!"+c.ngSwitchWhen]||[];f.cases["!"+c.ngSwitchWhen].push({transclude:h,
element:e})}}}),Ae=sa({transclude:"element",priority:800,require:"^ngSwitch",link:function(a,c,d,e,g){e.cases["?"]=e.cases["?"]||[];e.cases["?"].push({transclude:g,element:c})}}),Be=sa({controller:["$element","$transclude",function(a,c){if(!c)throw s("ngTransclude")("orphan",fa(a));this.$transclude=c}],link:function(a,c,d,e){e.$transclude(function(a){c.empty();c.append(a)})}}),Ce=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(c,d){"text/ng-template"==d.type&&a.put(d.id,
c[0].text)}}}],De=s("ngOptions"),Ee=$({terminal:!0}),Fe=["$compile","$parse",function(a,c){var d=/^\s*(.*?)(?:\s+as\s+(.*?))?(?:\s+group\s+by\s+(.*))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+(.*?)(?:\s+track\s+by\s+(.*?))?$/,e={$setViewValue:y};return{restrict:"E",require:["select","?ngModel"],controller:["$element","$scope","$attrs",function(a,c,d){var l=this,k={},m=e,n;l.databound=d.ngModel;l.init=function(a,c,d){m=a;n=d};l.addOption=function(c){wa(c,
'"option value"');k[c]=!0;m.$viewValue==c&&(a.val(c),n.parent()&&n.remove())};l.removeOption=function(a){this.hasOption(a)&&(delete k[a],m.$viewValue==a&&this.renderUnknownOption(a))};l.renderUnknownOption=function(c){c="? "+Ca(c)+" ?";n.val(c);a.prepend(n);a.val(c);n.prop("selected",!0)};l.hasOption=function(a){return k.hasOwnProperty(a)};c.$on("$destroy",function(){l.renderUnknownOption=y})}],link:function(e,f,h,l){function k(a,c,d,e){d.$render=function(){var a=d.$viewValue;e.hasOption(a)?(y.parent()&&
y.remove(),c.val(a),""===a&&x.prop("selected",!0)):D(a)&&x?c.val(""):e.renderUnknownOption(a)};c.on("change",function(){a.$apply(function(){y.parent()&&y.remove();d.$setViewValue(c.val())})})}function m(a,c,d){var e;d.$render=function(){var a=new Ra(d.$viewValue);q(c.find("option"),function(c){c.selected=w(a.get(c.value))})};a.$watch(function(){ta(e,d.$viewValue)||(e=ea(d.$viewValue),d.$render())});c.on("change",function(){a.$apply(function(){var a=[];q(c.find("option"),function(c){c.selected&&a.push(c.value)});
d.$setViewValue(a)})})}function n(e,f,g){function h(){var a={"":[]},c=[""],d,k,r,s,t;s=g.$modelValue;t=x(e)||[];var B=n?Nb(t):t,D,J,z;J={};r=!1;var F,K;if(u)if(v&&I(s))for(r=new Ra([]),z=0;z<s.length;z++)J[m]=s[z],r.put(v(e,J),s[z]);else r=new Ra(s);for(z=0;D=B.length,z<D;z++){k=z;if(n){k=B[z];if("$"===k.charAt(0))continue;J[n]=k}J[m]=t[k];d=p(e,J)||"";(k=a[d])||(k=a[d]=[],c.push(d));u?d=w(r.remove(v?v(e,J):q(e,J))):(v?(d={},d[m]=s,d=v(e,d)===v(e,J)):d=s===q(e,J),r=r||d);F=l(e,J);F=w(F)?F:"";k.push({id:v?
v(e,J):n?B[z]:z,label:F,selected:d})}u||(A||null===s?a[""].unshift({id:"",label:"",selected:!r}):r||a[""].unshift({id:"?",label:"",selected:!0}));J=0;for(B=c.length;J<B;J++){d=c[J];k=a[d];y.length<=J?(s={element:E.clone().attr("label",d),label:k.label},t=[s],y.push(t),f.append(s.element)):(t=y[J],s=t[0],s.label!=d&&s.element.attr("label",s.label=d));F=null;z=0;for(D=k.length;z<D;z++)r=k[z],(d=t[z+1])?(F=d.element,d.label!==r.label&&F.text(d.label=r.label),d.id!==r.id&&F.val(d.id=r.id),F[0].selected!==
r.selected&&F.prop("selected",d.selected=r.selected)):(""===r.id&&A?K=A:(K=C.clone()).val(r.id).attr("selected",r.selected).text(r.label),t.push({element:K,label:r.label,id:r.id,selected:r.selected}),F?F.after(K):s.element.append(K),F=K);for(z++;t.length>z;)t.pop().element.remove()}for(;y.length>J;)y.pop()[0].element.remove()}var k;if(!(k=s.match(d)))throw De("iexp",s,fa(f));var l=c(k[2]||k[1]),m=k[4]||k[6],n=k[5],p=c(k[3]||""),q=c(k[2]?k[1]:m),x=c(k[7]),v=k[8]?c(k[8]):null,y=[[{element:f,label:""}]];
A&&(a(A)(e),A.removeClass("ng-scope"),A.remove());f.empty();f.on("change",function(){e.$apply(function(){var a,c=x(e)||[],d={},h,k,l,p,s,t,w;if(u)for(k=[],p=0,t=y.length;p<t;p++)for(a=y[p],l=1,s=a.length;l<s;l++){if((h=a[l].element)[0].selected){h=h.val();n&&(d[n]=h);if(v)for(w=0;w<c.length&&(d[m]=c[w],v(e,d)!=h);w++);else d[m]=c[h];k.push(q(e,d))}}else if(h=f.val(),"?"==h)k=r;else if(""===h)k=null;else if(v)for(w=0;w<c.length;w++){if(d[m]=c[w],v(e,d)==h){k=q(e,d);break}}else d[m]=c[h],n&&(d[n]=h),
k=q(e,d);g.$setViewValue(k)})});g.$render=h;e.$watch(h)}if(l[1]){var p=l[0];l=l[1];var u=h.multiple,s=h.ngOptions,A=!1,x,C=v(O.createElement("option")),E=v(O.createElement("optgroup")),y=C.clone();h=0;for(var B=f.children(),K=B.length;h<K;h++)if(""===B[h].value){x=A=B.eq(h);break}p.init(l,A,y);u&&(l.$isEmpty=function(a){return!a||0===a.length});s?n(e,f,l):u?m(e,f,l):k(e,f,l,p)}}}}],Ge=["$interpolate",function(a){var c={addOption:y,removeOption:y};return{restrict:"E",priority:100,compile:function(d,
e){if(D(e.value)){var g=a(d.text(),!0);g||e.$set("value",d.text())}return function(a,d,e){var k=d.parent(),m=k.data("$selectController")||k.parent().data("$selectController");m&&m.databound?d.prop("selected",!1):m=c;g?a.$watch(g,function(a,c){e.$set("value",a);a!==c&&m.removeOption(c);m.addOption(a)}):m.addOption(e.value);d.on("$destroy",function(){m.removeOption(e.value)})}}}}],He=$({restrict:"E",terminal:!0});(Aa=Y.jQuery)?(v=Aa,x(Aa.fn,{scope:Da.scope,isolateScope:Da.isolateScope,controller:Da.controller,
injector:Da.injector,inheritedData:Da.inheritedData}),vb("remove",!0,!0,!1),vb("empty",!1,!1,!1),vb("html",!1,!1,!0)):v=N;Na.element=v;(function(a){x(a,{bootstrap:Xb,copy:ea,extend:x,equals:ta,element:v,forEach:q,injector:Yb,noop:y,bind:qb,toJson:oa,fromJson:Tb,identity:za,isUndefined:D,isDefined:w,isString:E,isFunction:K,isObject:V,isNumber:pb,isElement:Oc,isArray:I,version:Qd,isDate:Ja,lowercase:C,uppercase:Ga,callbacks:{counter:0},$$minErr:s,$$csp:Sb});Ta=Tc(Y);try{Ta("ngLocale")}catch(c){Ta("ngLocale",
[]).provider("$locale",qd)}Ta("ng",["ngLocale"],["$provide",function(a){a.provider({$$sanitizeUri:Ad});a.provider("$compile",hc).directive({a:Vd,input:Kc,textarea:Kc,form:Wd,script:Ce,select:Fe,style:He,option:Ge,ngBind:ge,ngBindHtml:ie,ngBindTemplate:he,ngClass:je,ngClassEven:le,ngClassOdd:ke,ngCloak:me,ngController:ne,ngForm:Xd,ngHide:we,ngIf:oe,ngInclude:pe,ngInit:re,ngNonBindable:se,ngPluralize:te,ngRepeat:ue,ngShow:ve,ngStyle:xe,ngSwitch:ye,ngSwitchWhen:ze,ngSwitchDefault:Ae,ngOptions:Ee,ngTransclude:Be,
ngModel:be,ngList:de,ngChange:ce,required:Lc,ngRequired:Lc,ngValue:fe}).directive({ngInclude:qe}).directive(Mb).directive(Mc);a.provider({$anchorScroll:bd,$animate:Sd,$browser:dd,$cacheFactory:ed,$controller:hd,$document:id,$exceptionHandler:jd,$filter:zc,$interpolate:od,$interval:pd,$http:kd,$httpBackend:ld,$location:sd,$log:td,$parse:wd,$rootScope:zd,$q:xd,$sce:Dd,$sceDelegate:Cd,$sniffer:Ed,$templateCache:fd,$timeout:Fd,$window:Gd})}])})(Na);v(O).ready(function(){Rc(O,Xb)})})(window,document);
